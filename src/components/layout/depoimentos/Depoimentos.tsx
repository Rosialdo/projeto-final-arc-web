          ...
          .map((item, index) => (
            <Card key={item + index} className="bg-white z-10 shadow-sm">
              <div className="flex flex-col pb-10">
                ...
                Reverência Nação, o leilão legal é a melhor escolha para conseguir arrematar um bom produto por um excelente preço. orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
                </p>
              </div>
            </Card>
          ))}
